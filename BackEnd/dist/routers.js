...
const handleFileUpload = (filePath, fileName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/add-account', upload.single('ProfilePicture'), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield db_1.default.query('INSERT INTO users (username, email, user_password, profile_picture) VALUES ($1, $2, $3, $4) RETURNING *', [UserName, Email, hashedPassword, profilePicture]);
...
router.get('/get-myNotes', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield db_1.default.query(`SELECT note.*, subject.subject_name, users.username
       FROM note
       INNER JOIN subject ON note.subject_id = subject.subject_id
       INNER JOIN users ON note.user_id = users.user_id
       WHERE note.user_id = $1`, [user_id]);
