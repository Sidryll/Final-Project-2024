document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateSubjects(): void {
    ...
    if (year === 'First-Year') {
      subjects = [
        'EMath 1101', 'RE 1', 'SE 1121', 'SEAL 1', 'PATHFIT1 M', 'PATHFIT1 W', 'NSTP1-CWTS', 'GEMath 1',
        'EMath 1101', 'EMath 1102', 'Engg 1001', 'GESocSci', 'EMath 1202', 'SEAL 2', 'Engg 1006', 'Engg 1009',
        'PATHFIT2 M', 'PATHFIT2 W', 'NSTP2-CWTS', 'RE 2', 'EMath 1201', 'SE 1241', 'SE 1242', 'SE 1243',
      ];
    } else if (year === 'Second-Year') {
      subjects = [
        'EE 2121', 'SE 2141', 'SE 2142', 'SE 2143', 'SE 2144', 'SE 2145', 'EMath 2101', 'PATHFIT3 M',
        'PATHFIT3 W', 'Emath 2103', 'SE 2236', 'SE 2237', 'SE 2238', 'SE 2239', 'SE 2240', 'GEHum 1',
        'PATHFIT4 M', 'PATHFIT4 W', 'GEEng 1', 'GESocsci 3',
      ];
    } else if (year === 'Third-Year') {
      subjects = [
        'SE 3141', 'SE 3142', 'SE 3143', 'SE 3144', 'CESocsci 3', 'CETech1', 'CELit1', 'Engg 1025', 'SE 3241',
        'SE 3242', 'SE 3243', 'SE 3244', 'GESocSci 4', 'GESocSci 5', 'GESocSci 1', 'Engg 1027', 'GESocSci 2',
      ];
    } else if (year === 'Fourth-Year') {
      subjects = ['Engg 1030', 'Engg 1036', 'Engg 1037', 'SE 4141', 'SE 4142', 'SE TE 1', 'SE 4241', 'SE 4242',
        'SE TE 2', 'SE TE 3', 'SE 4300'];
    }
